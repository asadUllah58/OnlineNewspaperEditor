            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="intro-message">
						...
						function deleteit(){
							?><script>alert("Running!!");</script><?php
						}
							...
							<div class="col-md-6">
								<ul class="list-inline intro-social-buttons">
									...
									<li class = "pull-right" style="padding:10px" >
										<a href="#" class="btn btn-default btn-md" id="delete"><i class="glyphicon glyphicon-trash"></i> <span class="network-name">Delete</span></a>
									</li>
								</ul>
							</div>
						</div>
